...
function solution1() {
    // 1. convert "number" to binary using "toString(2)" and save result to variable "binary" 

    // 2. add "0" to begining of "binary" while binary length is less than 8
    
    // 3. use array method "reverse" to reverse a string asd save result to variable "reversed"

    // 4. convert "reversed" to number using "parseInt(yourString, 2)" and return the result
}
